            ...
            <Grid container spacing={5} className={classes.centerBandWidth}>
              ...
              <Grid item xs={12} lg={4}>
                ...
                <Typography variant="h5">
                  Hi! Welcome to yet another budget tracking app! This one is fairly simple to use,
                  put in some incomes and outcomes and find out how rich you'll be in a few years!
                  <br />
                  <br />
